      ...
      >
        ...
        <div style={{ padding: "20px 24px 0", flexShrink: 0 }}>
          ...
          <button
            ...
            style={{ display: "inline-flex", alignItems: "center", gap: 4, background: "#1a7a3fcc", border: "none", borderRadius: 999, cursor: "pointer", padding: "6px 12px", margin: "10px 0 20px" }}
          >
            <span style={{ fontSize: 13, fontWeight: 600, color: "#fff" }}>{detailsOpen ? "Hide" : "Show me"}</span>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, transition: "transform 0.2s", transform: detailsOpen ? "rotate(180deg)" : "rotate(0deg)" }}><polyline points="6 9 12 15 18 9"/></svg>
          </button>
        </div>
