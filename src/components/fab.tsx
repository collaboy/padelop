  ...
  return (
    <>
      ...
      <button
        ...
        style={{ bottom: "calc(4rem + env(safe-area-inset-bottom))", right: "1.5rem", width: 54, height: 54, borderRadius: 27, background: "#e2e4e7", boxShadow: "0 2px 8px rgba(0,0,0,0.12)" }}
        aria-label="Add"
      >
