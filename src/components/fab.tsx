                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8, paddingTop: 0, paddingBottom: 10 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                      {([
                        ...
                        <button key={label} onClick={action} className="active:scale-95 transition-transform" style={{ background: "#ffffff", border: "none", borderRadius: 24, padding: "14px", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, textAlign: "center", aspectRatio: "1/1", width: "100%" }}>
                          {icon}
                          <div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                      <button
                        ...
                        style={{ background: "#ffffff", border: "none", borderRadius: 24, padding: "14px", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, textAlign: "center", aspectRatio: "1/1", width: "100%" }}
                      >
                      ...
                      <button
                        ...
                        className="active:scale-95 transition-transform"
                        style={{ background: "#ffffff", border: "none", borderRadius: 24, padding: "14px", cursor: checkinDone ? "default" : "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, textAlign: "center", aspectRatio: "1/1", width: "100%", position: "relative", opacity: checkinDone ? 0.5 : 1 }}
                      >
