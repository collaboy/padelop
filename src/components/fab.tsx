                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8, paddingTop: 0, paddingBottom: 10 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                      <button
                        ...
                        style={{ background: "#ffffff", border: "none", borderRadius: "50%", padding: "14px", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, textAlign: "center", aspectRatio: "1/1", width: "100%" }}
                      >
                      ...
                      <button
                        ...
                        className="active:scale-95 transition-transform"
                        style={{ background: "#ffffff", border: "none", borderRadius: "50%", padding: "14px", cursor: checkinDone ? "default" : "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, textAlign: "center", aspectRatio: "1/1", width: "100%", position: "relative", opacity: checkinDone ? 0.5 : 1 }}
                      >
            ...
            <div className="relative w-full bg-white rounded-t-[24px] shadow-2xl" style={{ paddingBottom: "env(safe-area-inset-bottom)", maxHeight: "82vh", overflowY: "auto" }} onClick={e => e.stopPropagation()}>
              ...
              <div style={{ padding: "10px 20px 4px" }}>
                <button
                  ...
                  style={{ width: "100%", padding: "13px 16px", borderRadius: 14, background: "#f4f4f6", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, opacity: insertUploadLoading ? 0.6 : 1 }}
                >
                  {insertUploadLoading ? (
                    <svg className="animate-spin" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6b7480" strokeWidth="2.5" strokeLinecap="round"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/></svg>
                  ) : (
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6b7480" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>
                  )}
                  <span style={{ fontSize: 15, fontWeight: 600, color: "#4a5050" }}>
