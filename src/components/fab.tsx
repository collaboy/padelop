      ...
      {logPickerOpen && (
        <div className="fixed inset-0 z-[200] flex items-end" onClick={closeAll} onTouchStart={e => e.stopPropagation()} onTouchMove={e => e.stopPropagation()} onTouchEnd={e => e.stopPropagation()}>
          ...
          <div className="relative w-full bg-white rounded-t-[28px] shadow-2xl" style={{ animation: "sheetUp 0.3s cubic-bezier(0.22,1,0.36,1)", overflow: "hidden", display: "flex", flexDirection: "column", maxHeight: "85dvh", paddingBottom: "env(safe-area-inset-bottom)" }} onClick={e => e.stopPropagation()}>
            ...
            {/* Green header strip */}
            <div style={{ background: "#00D455", padding: "20px 20px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
              <span style={{ background: "#fff", padding: "3px 8px", borderRadius: 4, fontSize: "clamp(20px, 6vw, 26px)", fontWeight: 800, color: "#000", lineHeight: 1 }}>padelop</span>
              ...
              <div style={{ padding: "16px 16px 24px", display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 0 0 1px #f0f0f0", marginBottom: 4 }}>
                  {([
                    ...
                    { label: "Insights", href: "/insights", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6b7480" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> },
                    { label: "Matches", href: "/matches", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6b7480" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
