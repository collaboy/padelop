      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        {step === 3 && (
          <>
            ...
            <p className="t-body-sm" style={{ color: "var(--c-text-sub)", margin: "0 0 20px" }}>Get gentle reminders for your morning routine and evening recovery. You can change this anytime in Settings.</p>
            <div style={{ width: 56, height: 56, borderRadius: "50%", background: "var(--c-blue-tint)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 12 }}>
