...
export function getScheduleItems(
  ...
  const items: Record<string, Array<{ time: string; title: string; body: string }>> = {
    match: [
      { time: "07:00", title: "Wake up & hydrate",    body: "500ml water before anything else" },
      { time: "07:30", title: "Breakfast",             body: "Oats, eggs, fruit" },
      { time: "09:00", title: "Morning mobility",      body: "Foam roll & light stretching" },
      { time: addMins(mH, mM, -360), title: "Pre-game meal",        body: "Chicken, rice, light salad" },
      { time: addMins(mH, mM, -60),  title: "Warmup & activation",  body: "Dynamic drills, 30 min" },
      { time: mt,                    title: "Match time",            body: "Game time — trust your prep" },
      { time: addMins(mH, mM, 90),   title: "Post-match cool down", body: "Stretch & mobility, 15 min" },
    ...
    recovery: [
      { time: "07:30", title: "Wake up & hydrate",  body: "500ml water — rehydrate after yesterday" },
      { time: "08:00", title: "Light breakfast",     body: "Eggs, fruit, Greek yogurt" },
      { time: "09:30", title: "Recovery walk",       body: "20 min easy — flush out lactic acid" },
      { time: "10:30", title: "Foam roll & stretch", body: "Quads, hip flexors, calves, shoulders" },
      { time: "13:00", title: "Protein-rich lunch",  body: "Chicken, salmon or legumes + veg" },
      ...
      { time: "21:30", title: "Early wind down",     body: "Sleep is your best recovery tool tonight" },
    ],
    training: [
      { time: "07:00", title: "Wake up & hydrate", body: "500ml water before coffee" },
      { time: "07:30", title: "Breakfast",          body: "High protein — eggs, yogurt, fruit" },
      { time: "09:30", title: "Light mobility",     body: "Hip flexors, thoracic spine, ankles" },
      { time: "11:00", title: "Skill Prep",         body: "Today's drill focus — open the app for details" },
      { time: "12:30", title: "Balanced lunch",     body: "Carbs + protein + greens" },
