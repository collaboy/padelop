export default function TrainingPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 pt-8 pb-8">
      ...
      {/* Drill of the Day */}
      <div className="bg-white rounded-[24px] overflow-hidden border border-[#c4c7c7]/10" style={{ boxShadow: "0px 4px 20px rgba(0,0,0,0.04)" }}>
        <div className="relative h-40">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
            <span className="text-[11px] font-semibold text-white bg-white/20 backdrop-blur-md px-3 py-1 rounded-full border border-white/20">
              Skill: Tactics
            </span>
          </div>
        </div>
        <div className="p-6">
          <h3 className="text-[20px] font-semibold text-black mb-1">Defensive Lob Mastery</h3>
          <p className="text-[15px] text-[#444748] mb-4">Master the depth and height to reset the point under pressure.</p>
