        ...
        <div className="bg-white rounded-[24px] h1-ambient border border-[#c4c7c7]/10 p-6">
          <div className="mb-5 flex items-center justify-between">
            ...
            >
              ...
              <span className="text-[11px] font-semibold text-[#6b7480]">{DAY_TYPE_META[dayType].label}</span>
              ...
              return (
                <div key={idx} ref={isCurrent ? currentRowRef : undefined} className="flex gap-3">
                  <div className="w-11 flex-shrink-0 pt-0.5">
                    <p className="text-[13px] font-semibold text-[#9aa0a8] text-right leading-none">{time}</p>
                  </div>
          ...
          return (
            <div className="bg-white rounded-[24px] h1-ambient border border-[#c4c7c7]/10 px-4 pt-5 pb-4">
              ...
              <div className="relative mt-4">
                ...
                <div className="absolute pointer-events-none" style={{ top: -7, left: `calc(${notchPct}% - 7px)`, zIndex: 2, width: 0, height: 0, borderLeft: "7px solid transparent", borderRight: "7px solid transparent", borderBottom: "7px solid #272b30" }} />
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center" onClick={() => setScheduleModal(null)}>
          ...
          <div className="relative w-full max-w-[640px] bg-white rounded-t-[28px] pb-10 shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-6 pt-5">
              <p className="h1-body-lg text-[#9aa0a8] leading-relaxed">{scheduleModal.detail}</p>
            </div>
            <button onClick={() => setScheduleModal(null)} className="absolute top-4 right-4 w-8 h-8 rounded-full bg-black/8 flex items-center justify-center active:opacity-60">
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="#9aa0a8" strokeWidth="2" strokeLinecap="round">
