        ...
        >
          ...
          <div style={{ width: "33.333%", flexShrink: 0, height: "100%", paddingLeft: 10, paddingRight: 10, position: "relative", zIndex: 2, overflow: "hidden" }}>
            <div style={{
              ...
              transform: doIdx === 1
                ? `translateY(calc(355px - 150vw - 150dvh))`
                : doIdx === -1
              ...
              {/* Card 0: encouragement (moved from bottom slot) */}
              {(() => {
                const title =
                ...
                return (
                  <div
                    key="card0"
                    style={{ width: "100%", flexShrink: 0, borderRadius: 24, background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 36px", gap: 2, zIndex: doIdx === -1 ? 2 : 1, height: "calc(100dvh - 120px)", overflow: "hidden", pointerEvents: doIdx === -1 ? "auto" : "none", opacity: doIdx === -1 ? 1 : 0, transition: "opacity 0.3s" }}
                  >
              ...
              {/* Card 2: My Game snapshot grid (moved into bottom slot) */}
              {(() => {
                ...
                return (
                  <div
                    key="card2"
                    style={{ width: "100%", flexShrink: 0, borderRadius: 24, background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 14, zIndex: doIdx === 1 ? 2 : 1, height: "calc(100dvh - 120px)", overflow: "hidden", pointerEvents: doIdx === 1 ? "auto" : "none", touchAction: "none", opacity: doIdx === 1 ? 1 : 0, transition: "opacity 0.3s" }}
