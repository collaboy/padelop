                ...
                if (isDone) {
                  ...
                  return (
                    <div key="done-card" style={{ ...cardStyle }} onClick={() => { setSchedModalIdx(currentIdx); setDoModalOpen(true); setModalDetailOpen(false); }}>
                      ...
                      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(circle, rgba(10,12,30,0.48) 0%, rgba(10,12,30,0.72) 65%, rgba(10,12,30,0.85) 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 0, animation: justDone ? "fade-in 1.5s ease-out 1s both" : undefined }}>
